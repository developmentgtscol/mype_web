...
class ZonaInfluencia:
    def solicitar_zona_Influencia(self,latitud,longitud):
        ...
        try:
            ...
            zona2=[(11.01434,-74.79428),(11.00726,-74.79969),(11.00275,-74.80655),(11.00514,-74.81121),(11.0086,-74.81413),(11.01391,-74.80915),(11.02073,-74.80709),(11.02587,-74.80305),(11.01434,-74.79428)]
            ...
            for  i in range(num):
                ...
                if estado_poligono==True:
                    ...
                    if len(datos)!=0:
                        ...
                        return False,'esta zona no tiene cobertuna comunicarce al 00000001'        
                
            return False,'esta zona no tiene cobertuna comunicarce al 0000000'
        except Exception as identifier:
            print(identifier)
            codigo = generador.validarGuardarInformacionError("000","zona de influencia error , gerente- validaciones","post",'')
            return False,codigo     
